...
Pod::Spec.new do |s|
  ...
  s.description  = "the newwork request, as a part of app"

  s.homepage     = "https://git.wdwd.com/appmodules/amdnetworkservice"
  ...
  s.source       = { :git => "https://github.com/xie244135119/AMDNetworkService.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "AMDNetworkService/AMDNetworkService.h"
  ...
  # s.dependency "JSONKit", "~> 1.4"
	...
	s.subspec 'Private' do |st|
		...
		st.dependency "AMDNetworkService/ThirdSdk"
	end
